...
| 4. Optimización | Objetivos, límites, referencias y [sensibilidad histórica](allocation_sensitivity.md) | Restricciones factibles; comparación con alternativas simples; diagnóstico de estabilidad inicial disponible; asignación por perfil solo después de resolver las condiciones legales y laborales |
