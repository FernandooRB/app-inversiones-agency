...
| 4. Optimización | Objetivos, límites, referencias, [política por clase](allocation_policy.md), [sensibilidad histórica](allocation_sensitivity.md) y [covarianza diagonal fija o calibrada](covariance_shrinkage.md) | Restricciones individuales y por clase factibles; comparación con alternativa simple factible; calibración interna sin datos externos disponibles; falta validarla en más regímenes y universos; asignación por perfil solo después de resolver las condiciones legales y laborales |
