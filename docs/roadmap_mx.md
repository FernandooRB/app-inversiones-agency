...
| 3. Instrumentos | Acciones/ETF mexicanos y SIC; CETES, [Bonos M](bonos_m_adapter.md) y [liquidez MXN](liquidity_adapter.md) preparados por archivo; fondos pendientes | Valoración y flujos apropiados por tipo; no tratar rendimiento a vencimiento como retorno total diario; validar externamente precios, devengado, cupones y tasas contractuales |
