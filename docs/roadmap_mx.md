...
| 4. Optimización | Objetivos, límites, referencias, [sensibilidad histórica](allocation_sensitivity.md) y [covarianza diagonal de contraste](covariance_shrinkage.md) | Restricciones factibles; comparación con alternativas simples; diagnósticos de estabilidad disponibles; falta calibrar estimadores; asignación por perfil solo después de resolver las condiciones legales y laborales |
