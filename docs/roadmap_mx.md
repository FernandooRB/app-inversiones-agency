...
| 3. Instrumentos | Acciones/ETF mexicanos y SIC; CETES y [Bonos M](bonos_m_adapter.md) preparados por archivo; fondos y efectivo pendientes | Valoración y flujos apropiados por tipo; no tratar rendimiento a vencimiento como retorno total diario; validar externamente precios, devengado y cupones por emisión |
