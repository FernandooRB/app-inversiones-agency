...
| Posiciones y operaciones | Total, fecha, universo, valuación, efectivo y movimientos conciliados contra estado del intermediario; sin datos personales en repositorio | Controles opcionales de fecha, detalle, subtotal, cobertura, puente aritmético de efectivo liquidado y puente de cantidades por instrumento disponibles; faltan contraste del estado original y comprobación de integridad de operaciones y eventos |
