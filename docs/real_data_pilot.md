...
| Posiciones y operaciones | Total, fecha, universo, valuación, efectivo y movimientos conciliados contra estado del intermediario; sin datos personales en repositorio | Controles opcionales de fecha, detalle, subtotal y cobertura de efectivo/otras partidas disponibles; revisión del estado original y movimientos pendiente |
