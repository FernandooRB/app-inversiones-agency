...
| Posiciones y operaciones | Total, fecha, universo, valuación, efectivo y movimientos conciliados contra estado del intermediario; sin datos personales en repositorio | Control opcional de fecha y total disponible; revisión del estado, efectivo y movimientos pendiente |
