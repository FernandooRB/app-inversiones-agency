...
| Posiciones y operaciones | Total, fecha, universo, valuación, efectivo y movimientos conciliados contra estado del intermediario; sin datos personales en repositorio | Controles opcionales de fecha, total y detalle por instrumento disponibles; revisión del estado original, efectivo y movimientos pendiente |
